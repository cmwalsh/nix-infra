{...}: {
  virtualisation.oci-containers.containers = {
    dns-server = {
      image = "ghcr.io/technitium/dns-server:latest";
      hostname = "technitium";
      autoStart = true;
      ...
      volumes = [
        "/mnt/ironwolf/appdata/technitium:/etc/dns"
      ];
      ...
      environment = {
        ...
        DNS_SERVER_FORWARDERS = "194.242.2.4"; #Comma separated list of forwarder addresses.
